...
* Choose the simplest analysis that answers it well

* Focus on insights, assumptions, and next actions

* Communicate results so both technical and non-technical stakeholders can act
...
* Funnel, conversion, and retention analysis

* Performance metrics and KPI design

* Analytical SQL and structured data exploration
